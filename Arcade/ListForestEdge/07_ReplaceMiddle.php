...
The middle consists of two elements, 2 and 5. These two elements should be replaced with their
sum, i.e. 7.
...
arr with its middle replaced by a single element, or the initial array if the middle consisted of
a single element to begin with.
 */
...
function replaceMiddle($arr) {
    ...
    if ($size % 2 == 0) { // even number of elements
        ...
        array_splice($arr, $midIndex-1, 2, [$middleValue]);
    }
